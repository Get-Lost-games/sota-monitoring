  ...
  return (
    <>
      ...
      <div className="box">
        ...
        <img className="cam" src="http://163.158.76.26/mjpg/video.mjpg" />
      </div>
      <div className="box">
        <div className="box-label">52.8872546,6.1161903</div>

        <img className="cam" src="http://213.184.127.123:82/mjpg/video.mjpg" />
      </div>
      <div className="box">
        <div className="box-label">52.7158545,6.8324473</div>

        <img className="cam" src="http://213.124.36.2/mjpg/video.mjpg" />
      </div>
    </>
  );
};
